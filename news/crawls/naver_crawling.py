...
def extract_naver_article_data(url):
    """
    ...
    for element in content:     
        try:
            ...
            print('Element not desired')


    return {'press': press, 'headline': headline, 'date': date, 
...
if __name__ == "__main__":
    url = "https://n.news.naver.com/mnews/article/016/0002022739?sid=104"
    crawl_news_from_naver()
